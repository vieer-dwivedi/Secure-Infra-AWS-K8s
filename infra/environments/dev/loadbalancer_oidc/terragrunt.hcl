...
inputs = {
  ...
  attach_role = true
  role_name            = "${local.config.eks.cluster_name}-lb-role"
  managed_policy_arns  = ["arn:aws:iam::aws:policy/ElasticLoadBalancingFullAccess", "arn:aws:iam::aws:policy/AmazonEC2FullAccess", "arn:aws:iam::aws:policy/AWSWAFFullAccess"]
